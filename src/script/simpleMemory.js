...
if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        ...
        homeTopImg: [
            "https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/home_top_bg.webp"
        ],
        homeBannerText: "",
        homeBannerTextType: "jinrishici",
        essayTopImg: [
            "https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/nothome_top_bg.webp"
        ],
...
function getVersionConfig() {
    ...
    } else if(window.cnblogsConfig.GhUserName === 'lovelyemperor') {
        window.themeVersion = [
            [
                "v1.1.6",
...
function init() {
    ...
    var navListHtml = '<li><a href="https://www.cnblogs.com/'+user+'/" target="_self">首页</a></li>' +
        ...
        '<li><a href="https://i-beta.cnblogs.com/posts/edit" target="_blank">随笔</a></li>' +
