...
//----------------------------- Loading 前后逻辑处理 ----------------------------------//
    ...
    this.loadingAfterInit = function () {
        ...
        // 设置菜单个人简介头像
        var blogAvatar = window.cnblogsConfig.blogAvatar ? window.cnblogsConfig.blogAvatar : 'https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp';
            ...
            commentList.each(function (i) {
                ...
                if (p.length > 0) {
                    ...
                    if (op.length > 0 && op.text() != '') {
                        ...
                        html += '<img class="comment-avatar" src="https://cdn.jsdelivr.net/gh/lovelyemperor/Cnblogs-Theme-SimpleMemory@master/img/webp/default_avatar.webp"/>';
                    }
